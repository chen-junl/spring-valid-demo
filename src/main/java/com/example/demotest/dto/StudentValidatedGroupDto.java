 ...
 */
@Data
public class StudentValidatedGroupDto {
    /**
     * 主键
     */
    ...
    /**
     * 创建者
     * create 字段的NotNull声明了InsertGroup分组,只会在@validated同时也申明为InsertGroup分组的时候才会起作用
     */
    @NotNull(message = "学生创建者不能为空", groups = {InsertGroup.class})
    private String creator;
    /**
     * 修改者
     * modifier 字段的NotEmpty声明了InsertGroup分组,只会在@validated同时也申明为UpdateGroup分组的时候才会起作用
     */
    @NotEmpty(message = "学生修改者不能为空", groups = {UpdateGroup.class})
